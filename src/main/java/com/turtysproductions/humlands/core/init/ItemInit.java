...
public class ItemInit {
	...
	public static final RegistryObject<Item> FLUX_VIAL = ITEMS.register("flux_vial", () -> new FluxVial(() -> Fluids.EMPTY, new Item.Properties().group(HumlandsTab.HUMLANDS).maxStackSize(16)));
