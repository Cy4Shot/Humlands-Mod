...
public class BlockInit {
	...
	public static final RegistryObject<Block> BLUE_FOREST_GRASS_BLOCK = BLOCKS.register("blue_forest_grass_block",
			() -> new Block(PropertyInit.DIRT_PROPERTY));

	public static final RegistryObject<Block> GREEN_FOREST_GRASS_BLOCK = BLOCKS.register("green_forest_grass_block",
			() -> new Block(PropertyInit.DIRT_PROPERTY));

	public static final RegistryObject<Block> HUMLANDS_PORTAL_BLOCK = BLOCKS.register("humlands_portal_block",
			() -> new Block(PropertyInit.PORTAL_PROPERTY));

	public static final RegistryObject<Block> SCRAP_SAND = BLOCKS.register("scrap_sand",
			() -> new ScrapSandBlock(PropertyInit.SAND_PROPERTY));

	public static final RegistryObject<Block> SCRAP_SANDSTONE = BLOCKS.register("scrap_sandstone",
			() -> new Block(PropertyInit.SANDSTONE_PROPERTY));

	public static final RegistryObject<Block> SCRAP_GLASS = BLOCKS.register("scrap_glass",
			() -> new ScrapGlassBlock(PropertyInit.GLASS_PROPERTY));

	public static final RegistryObject<Block> SIFTER = BLOCKS.register("sifter",
			() -> new SifterBlock(PropertyInit.MACHINE_PROPERTY.notSolid()));
	...
	public static final RegistryObject<Block> RUBBER_LEAVES = BLOCKS.register("rubber_leaves", () -> new CustomLeaves(
			Block.Properties.create(Material.LEAVES).hardnessAndResistance(3.0F, 3.0F).sound(SoundType.PLANT)));
