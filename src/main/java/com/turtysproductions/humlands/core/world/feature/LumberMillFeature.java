...
public class LumberMillFeature extends Feature<NoFeatureConfig>
{
	...
	private static final ResourceLocation STRUCTURE_LUMBER_MILL_1 = new ResourceLocation("humlands:lumbermill/lumber_mill");
	
	
	private static final ResourceLocation[] LUMBER_MILLS = new ResourceLocation[] 
			{ 
					STRUCTURE_LUMBER_MILL_1			
			};
