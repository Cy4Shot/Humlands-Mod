...
public class HumlandsBlueForestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	...
	public HumlandsBlueForestSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> config) {
		super(config);
	}
	...
	public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise,
		...
		SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock,
				...
				new SurfaceBuilderConfig(BlockInit.BLUE_FOREST_GRASS_BLOCK.get().getDefaultState(),
