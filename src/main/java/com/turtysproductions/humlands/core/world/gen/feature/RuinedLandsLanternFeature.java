...
public class RuinedLandsLanternFeature extends Feature<NoFeatureConfig> {

	private static final ResourceLocation LANTERN_1 = new ResourceLocation("humlands:ruined_lands/lantern/lantern_1");
	private static final ResourceLocation LANTERN_2 = new ResourceLocation("humlands:ruined_lands/lantern/lantern_2");
	private static final ResourceLocation LANTERN_3 = new ResourceLocation("humlands:ruined_lands/lantern/lantern_3");
	private static final ResourceLocation[] LANTERNS = new ResourceLocation[] { LANTERN_1, LANTERN_2, LANTERN_3 };

	public RuinedLandsLanternFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
		super(config);
	}
	...
	public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand,
		...
		Template template = ((ServerWorld) worldIn.getWorld()).getSaveHandler().getStructureTemplateManager()
				.getTemplateDefaulted(LANTERNS[random.nextInt(LANTERNS.length)]);
