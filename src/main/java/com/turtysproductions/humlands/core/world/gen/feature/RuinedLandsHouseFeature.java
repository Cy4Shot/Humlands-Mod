...
public class RuinedLandsHouseFeature extends Feature<NoFeatureConfig> {

	private static final ResourceLocation HOUSE_1 = new ResourceLocation("humlands:ruined_lands/house/house_1");
	private static final ResourceLocation HOUSE_2 = new ResourceLocation("humlands:ruined_lands/house/house_2");
	private static final ResourceLocation HOUSE_3 = new ResourceLocation("humlands:ruined_lands/house/house_3");
	private static final ResourceLocation[] HOUSES = new ResourceLocation[] { HOUSE_1, HOUSE_2, HOUSE_3 };

	public RuinedLandsHouseFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
		super(config);
	}
	...
	public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand,
		...
		Template template = ((ServerWorld) worldIn.getWorld()).getSaveHandler().getStructureTemplateManager()
				.getTemplateDefaulted(HOUSES[random.nextInt(HOUSES.length)]);
