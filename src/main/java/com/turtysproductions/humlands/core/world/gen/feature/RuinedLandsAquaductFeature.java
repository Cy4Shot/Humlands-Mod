...
public class RuinedLandsAquaductFeature extends Feature<NoFeatureConfig> {

	public RuinedLandsAquaductFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
		super(config);
	}
	...
	public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand,
		...
		Template template = ((ServerWorld) worldIn.getWorld()).getSaveHandler().getStructureTemplateManager()
				.getTemplateDefaulted(new ResourceLocation("humlands:ruined_lands/aquaduct/aquaduct"));
