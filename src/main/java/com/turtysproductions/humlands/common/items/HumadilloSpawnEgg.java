...
public class HumadilloSpawnEgg extends Item
{
	...
	//Removing the .add(0, 1, 0) from context.getPos() will make your entity spawn
	//a little underground, creating a cool emerging effect.
    @Override
    public ActionResultType onItemUse(ItemUseContext context) 
    {
    	   EntityType<Humadillo> humadillo = EntityTypesInit.HUMADILLO.get();
           
           Entity humadillo1 = humadillo.spawn(context.getWorld(), context.getItem(), context.getPlayer(), context.getPos().add(0, 1, 0), SpawnReason.SPAWN_EGG, false, false);
