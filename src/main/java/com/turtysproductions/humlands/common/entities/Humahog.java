...
import com.turtysproductions.humlands.common.entities.ai.SuckRubberGoal;
...
{
	private static final DataParameter<Boolean> RUBBER_SUCKED = EntityDataManager.createKey(Humahog.class, DataSerializers.BOOLEAN);
	...
	protected void registerGoals() {
		...
		//this.targetSelector.addGoal(2, new MeleeAttackGoal(this, (double)0.20f, false));
		this.goalSelector.addGoal(3, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, true));
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal<>(this, Humadillo.class, true));
