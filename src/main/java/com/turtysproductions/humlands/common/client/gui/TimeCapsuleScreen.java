...
public class TimeCapsuleScreen extends ContainerScreen<TimeCapsuleContainer> {
	...
	private static final ResourceLocation TIME_CAPSULE_GUI = new ResourceLocation(HumlandsMod.MOD_ID,
			"textures/gui/time_capsule_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		// drawString takes in the startX and startY of the text by using float values,
