package com.turtysproductions.humlands.common.particles.rubber;
...
{    
	...
	private IAnimatedSprite spriteSet;
	    ...
	    public DrippingRubberParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double speedIn) {
